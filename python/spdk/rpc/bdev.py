...
def bdev_crypto_accel_create(client, base_bdev_name, name, dek):
    """Construct a crypto virtual block device.
    ...
    Returns:
        Name of created virtual block device.
    """
    params = {'base_bdev_name': base_bdev_name, 'name': name, 'dek': dek}
    return client.call('bdev_crypto_accel_create', params)


def bdev_crypto_accel_delete(client, name):
    """Delete crypto virtual block device.
    ...
    """
    params = {'name': name}
    return client.call('bdev_crypto_accel_delete', params)
